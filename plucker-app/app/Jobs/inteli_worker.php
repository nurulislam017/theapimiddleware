...
class inteli_worker implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        //Disabling the IP if the doamin is expired - Cute 
        /*

        Disabling this section for the opensource code
        ...
        and domain_routings.status != 'Inactive'
    ...
    */
        ...
        if ($this->log->analysis != 'Failed') {
            ...
            // Adding method to database and updating if already exists;
