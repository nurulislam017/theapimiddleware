...
class TotalRequests extends Component
{
    ...
    public function render()
    {
        ...
        $this->total_requests = DB::select("select count(client) as count from loggers,cluster_apis,apis where 
        ...
        $this->total_requests = $this->total_requests[0]['count'];
        ...
        return view('livewire.apis.cluster.logs.total-requests');
    }
}
