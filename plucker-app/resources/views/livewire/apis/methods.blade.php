<div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
    ...
    @endphp
    <div id="chart-api-methods"></div>
    <script>
        const optsApiMethods = {
        ...
        if (document.getElementById('chart-api-methods') && typeof ApexCharts !== 'undefined') {
            new ApexCharts(document.getElementById('chart-api-methods'), optsApiMethods).render();
        }
    </script>
</div>
