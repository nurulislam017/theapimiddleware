<div class="bg-white border border-zinc-200 rounded-xl overflow-hidden">
    <div class="px-5 py-3 border-b border-zinc-100">
        <p class="text-xs text-zinc-500 uppercase tracking-wide font-medium">Response Codes</p>
    </div>
    <div class="divide-y divide-zinc-50">
        ...
        @php
            ...
            $codeClass = match(true) {
                ...
                $code >= 300 => 'bg-zinc-100 text-zinc-600',
        ...
        @empty
        <div class="px-5 py-10 text-center text-xs text-zinc-400">No responses in this period</div>
        @endforelse
    </div>
</div>
